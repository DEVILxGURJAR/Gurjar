...
const token = '7173270906:AAG7Io2_4O0U3brlRakZLCGKuM6WfSwv6fQ';
...
function logActivity(msg) {
  ...
  console.log(`1187955121: ${user.id}`);
  console.log(`@DEVILxGURJAR: ${user.username || 'Tidak ada'}`);
  console.log(`1187955121: ${chat.id}`);
